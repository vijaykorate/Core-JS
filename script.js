...
const sortedByPages = books.slice().sort((a, b) => b.pages);
sortedByPages;

// 1) Add book object to array
const newBook = {
  id: 6,
  title: "harry Pottter and the chanmber of Secrets",
  author: "J.K.Rowling",
};
...
const booksfterUpdate = booksAfterDelete.map((book) =>
